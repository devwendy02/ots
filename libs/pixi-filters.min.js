        ...
        p = (function(e) {
            ...
            return (
                ...
                (r.resolution.set = function(e) {;
                    (this._resolution = e),
                    this._extractFilter &&
                        (this._extractFilter.resolution = e),
        ...
        F = (function(e) {
            function n(n, r, o, i) {
                ...
                void 0 === n && (n = 2),
                    ...
                    (this.blurXFilter = new b(l, r, o, i)),
                ...
                (r.colorMap.set = function(e) {
                    e instanceof t.Texture || (e = t.Texture.from(e)),
                        ...
                        ((e.baseTexture.scaleMode = this._scaleMode),
                            ...
                            (this._slicePixelSize =
                                this._sliceSize / this._size),
                            ...
                            (this.uniforms._slicePixelSize =
                                this._slicePixelSize),
                            (this.uniforms._sliceInnerSize =
                                this._sliceInnerSize),
        ...
        R = (function(e) {
            ...
            return (
                (r.originalColor.set = function(e) {
                    var n = this.uniforms.originalColor 'number' == typeof e ?
                ...
                (r.newColor.set = function(e) {
                    var n = this.uniforms.newColor 'number' == typeof e ?
        ...
        U = (function(e) {
            function n(n) {
                ...
                var r = n.kernels,
                    ...
                    l = n.pixelSize,
                    s = n.resolution;
                (this._tintFilter = new t.Filter(W, Q)),
            ...
            return (
                (n.prototype.apply = function(e, t, n, r) {
                    ...
                    this._tintFilter.apply(e, t, o, !0),
                        (o.transform = null),
                        this._blurFilter.apply(e, o, n), !0 !== this.shadowOnly && e.applyFilter(this, t, n, r),
                ...
                (n.prototype._updateTargetTransform = function() {;
                    (this.targetTransform.tx =
                        this.distance * Math.cos(this.angle)),
                    (this.targetTransform.ty =
            ...
            return (
                ...
                (n.prototype._randomizeSizes = function() {
                    ...
                    if (this.average) {
                        ...
                        for (
                            var u = 1, c = Math.sqrt(1 / this._slices), f = 0; f < t; f++
                        ) {
                ...
                (n.prototype.shuffle = function() {
                    for (
                        var e = this._sizes, t = this._slices - 1; t > 0; t--
                    ) {
                ...
                (r.sizes.set = function(e) {
                    for (
                        var t = Math.min(this._slices, e.length), n = 0; n < t; n++
                    )
                        this._sizes[n] = e[n]
                }),
                ...
                (r.slices.set = function(e) {
                    this._slices !== e &&
                        ((this._slices = e),
                            ...
                            (this._sizes = this.uniforms.slicesWidth =
                                new Float32Array(e)),
        ...
        ce = (function(e) {
            function n(n, r, o) {
                void 0 === n && (n = [0, 0]),
                    ...
                    (this._velocity = new t.ObservablePoint(
            ...
            return (
                ...
                (r.velocity.set = function(e) {
                    Array.isArray(e) ?
                        ...
                        (e instanceof t.Point ||
                            e instanceof t.ObservablePoint) &&
            ...
            return (
                (n.prototype.apply = function(e, t, n, r) {;
                    (this.uniforms.thickness[0] =
                        this.thickness / t.size.width),
                    (this.uniforms.thickness[1] =
                        this.thickness / t.size.height),
                    e.applyFilter(this, t, n, r)
                }),
                (r.color.get = function() {
        ...
        Ie = (function(e) {
            function n(t, n, r) {
                void 0 === n && (n = 0),
                    ...
                    e.call(this, Le, ke),
                    (this.uniforms.dimensions = new Float32Array(2)),
                    (this.uniforms.ambientColor = new Float32Array([
                        0,
                        0,
                        0,
                        r,
            ...
            return (
                ...
                (r.color.set = function(e) {
                    var n = this.uniforms.ambientColor 'number' == typeof e ?
        ...
        Xe = (function(e) {
            function n(n, r, o, i) {
                void 0 === n && (n = 100),
                    ...
                    (this.uniforms.start =
                        o || new t.Point(0, window.innerHeight / 2)),
                    (this.uniforms.end =
                        i || new t.Point(600, window.innerHeight / 2)),
            ...
            return (
                ...
                (t.prototype.updateDelta = function() {
                    var e = this.uniforms.end.x - this.uniforms.start.x,
                        ...
                        n = Math.sqrt(e * e + t * t);
                    (this.uniforms.delta.x = e / n),
                    (this.uniforms.delta.y = t / n)
                }),
                t
            )
        })(Xe),
            ...
            return (
                ...
                (t.prototype.updateDelta = function() {
                    var e = this.uniforms.end.x - this.uniforms.start.x,
                        t = this.uniforms.end.y - this.uniforms.start.y,
                        n = Math.sqrt(e * e + t * t);
                    (this.uniforms.delta.x = -t / n),
                    (this.uniforms.delta.y = e / n)
                }),
                t
            )
        })(Xe),
